...
function AchievementItemRow({ item }: { item: AchievementItem }) {
  return (
    <div className="flex shrink-0 items-center gap-[14px] whitespace-nowrap px-[40px]">
...
export default function AchievementInfinityStripCenteredNoBorders() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[980px] overflow-hidden bg-white py-6">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-[90px] bg-linear-to-r from-white to-transparent" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-[90px] bg-linear-to-l from-white to-transparent" />

      <div
        className="flex w-max items-center"
        style={{
          animation: "achievementMarqueeCenteredNoBorders 22s linear infinite",
